...
async function getPlatformConfig(name) {
    ...
    return Object.assign(Object.assign({}, platform), { source, target, pl });
}
...
export { successLog, errorLog, messageLog, isLowerCaseEqual, getPlatformInfo, getPlatformConfig, isTranslationPlatformNotFound, changeLanguageCode, matchPlatformLanguageCode, showLanguageList, readFile, writeFile };
